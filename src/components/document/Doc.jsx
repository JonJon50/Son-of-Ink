  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.guide}>
        ...
        <p className={styles.text}>
          Wear something appropriate. Remember what part of your body we need access to. Darker colors are better. Don&apos;t wear something brand new and/or white, as we are likely to get some ink on it. Avoid tight clothing.
        </p>
      </div>
      <div className={styles.consent}>
        <p className={styles.download}> Click Here... </p>
        <a href="/Assets/ConsentForm.jpeg" download className={styles.downloadLink}>
          Consent and Release Form
        </a>
        <p className={styles.description}>
          Before we proceed with your tattoo, it is essential to review and sign our Consent and Release Form. This document ensures that you understand and agree to the terms of service, including acknowledging the risks associated with tattooing and confirming your consent to the procedure.
        </p>
      </div>
    </div>
  );
